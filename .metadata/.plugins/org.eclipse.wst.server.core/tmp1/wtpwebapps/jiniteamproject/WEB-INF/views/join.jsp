      ...
      <form role="form" name="f" method="post" onsubmit="return validate();">
      	<div class="box-body">
      		...
      		<div class="box-group"> 
      			...
      			<input type='hidden' id='idcheck1' name='idcheck1' class="form-control" value="중복확인을 하십시오." style="color:red; width:200px;">
      			<input type='hidden' id='idcheck2' name='idcheck2' class="form-control" value="중복확인이 완료되었습니다." style="color:green; width:200px;" >
      			<input type='hidden' id='idcheck3' name='idcheck3' class="form-control" value="잘못된 아이디 형식입니다." style="color:red; width:200px;">		
      		</div>
